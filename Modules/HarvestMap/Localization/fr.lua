...
Harvest.localizedStrings = {
	-- description du haut
	["esouidescription"] = "Pour la description et la FAQ de cet addon, visitez sa page sur esoui.com",
	["openesoui"] = "Ouvrir ESOUI",
	["exchangedescription2"] = "Vous pouvez télécharger les données HarvestMap les plus récentes (positions des ressources) en installant le module complémentaire HarvestMap-Data. Pour plus d'informations, consultez la description de l'addon sur ESOUI.",
	...
	spawnfilterdescription = [[Lorsqu'il est activé, HarvestMap masquera les icônes pour les ressources qui n'ont pas encore réapparues.
